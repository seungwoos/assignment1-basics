...
from cs336_basics.optimizer import AdamW, cosine_lr_scheduler
...
def run_multihead_self_attention(
    ...
    return mhsa(x=in_features, token_positions=None)
...
def run_multihead_self_attention_with_rope(
    ...
    return mhsa(x=in_features, token_positions=token_positions)
